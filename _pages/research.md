...
> Abstract: We study the long-term effect of access to state-funded early childhood education programs on educational attainment and labor market outcomes. To do so, we exploit quasi-random variation across districts and cohorts as a result of the phased rollout of Texas's large-scale public Pre-K program. Using restricted-access administrative data, we find that access to Pre-K substantially increases public Pre-K enrollment, particularly in districts without alternative preschool options. However, we find heterogeneous effects of access across districts: in districts offering Pre-K to three- and four-year-olds simultaneously, access at age 3 increases high school graduation and decreases juvenile crime. As a result, we show a 5 percent increase in earnings at age 23, but these gains do not persist into the late twenties. In contrast, districts that primarily provide access for four-year-olds show precise null effects on long- and intermediate-term outcomes.
